...
本仓库当前整理三个插件。各插件目录均保留对应最新附件版本的源码、`build.bat` 与审计/说明文件，并提供独立中文使用教程。

| 插件 | 当前版本 | 运行环境 | 主要用途 |
|---|---:|---|---|
| [KK_TimelineStateCleaner](./KK_TimelineStateCleaner/) | 1.3.1 | CharaStudio | 一键取消/恢复指定 Timeline 相机与服装状态轨道勾选 |
| [KK_DragCoordinateLoadBridge](./KK_DragCoordinateLoadBridge/) | 1.2.1 | CharaStudio / Koikatu Maker | 将拖拽服装卡接入 Coordinate Load Option 的选择性加载流程 |
